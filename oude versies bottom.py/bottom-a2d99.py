...
# a2d999406ddffbd6506e99c8cf076a1a9908d9dd
    ...
    if inbuf == 'A':
        ...
        while 1:
            ...
            if color != 0:
                ...
                # kies een shift die een score groter dan 0 geeft
                # EN GEEN VERANDERING!!
                for move in random.shuffle(['U','D','L','R']):
                    temp = Bord(huidige_toestand)  # maak kopie
                    temp.move_game_notation(move)
                    print >>sys.stderr, temp.dump(), huidige_toestand
